...
@section('content')
    ...
    <form action="{{ route('owners.update', $owner) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="first_name" id="first_name" class="form-control" value="{{ old('first_name', $owner->first_name) }}" required>
        </div>

        <div class="mb-3">
            <label for="last_name" class="form-label">Nazwisko:</label>
            <input type="text" name="last_name" id="last_name" class="form-control" value="{{ old('last_name', $owner->last_name) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="commission_rate" id="commission_rate" class="form-control" value="{{ old('commission_rate', $owner->commission_rate) }}" required>
        </div>
